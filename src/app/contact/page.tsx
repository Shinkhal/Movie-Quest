...
export default function Contact() { 
  ...
  return (
    <div className="isolate text-white px-6 py-24 sm:py-32 lg:px-8 drop-shadow-lg">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text sm:text-4xl">Contact Us</h2>
